...
It's easy to experience high-speeds while going downhill. In the next figure, the sequence of actions required during corner negotiation are represented for a generic downhill high speed corner. As you can see, a change in the body position is required to use the body as a air brake, and then to negotiate the corner. Although the different actions might be the same, every rider can choose a particular timing for every action and a particular strategy for execution.    
