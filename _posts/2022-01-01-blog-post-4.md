...
Knowing what the 'optimal' trajectory might be and actually following it are two very different things. All the blog posts I read about the topic share one tip in common, and it sounds pretty much like: 'you need to relax'! Yep, easy to say, but hard to execute. Descents are often cold, windy and repulsive: it's no joke. Putting in practice what guidelines suggest it's hard, if not impossible. However, visualization and mental preparation can be a very useful tool. In the end, *bike handling* is about knowing very well what is going to happen, and being able to leverage this knowledge to gain competitive advantage. 
