...
Following the simulation study, we set out to process experimental data collected on professional cyclists during an individual time trial with considerable technical content ([see this link](https://www.tandfonline.com/doi/abs/10.1080/17461391.2021.1966517)). 

☁️ __The gg diagram was assessed for 27 riders: a 10% bigger cloud in the gg diagram was associated with 20 positions in the final rank.__ 

Yes, of course, take these number and indications with a pinch of salt! They might be provide indications and they are not absolutes. However, something is better than nothing, right?
...
Most of the notions and terminology I used in this post might result poorly accurate for an expert in vehicle dynamics. I didn't want to overly simplify concepts and terms, I just tried to keep only what I thought it was necessary. Even thou bicycles have been introduced 200 years ago, interaction between bike and rider is a challenging research topic. 
