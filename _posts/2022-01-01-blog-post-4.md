...
It is difficult to estimate the contribution that *bike handling* can have on cycling performance. Difficult, but not impossible. As you might acknowledge, *bike handling* assessment requires information about the accelerations, and they are never easily retrieved. With some degree of accuracy, accelerations might be estimated with GPS. Estimated accelerations can provide insightful recommendations. 
...
⏱️ __With a very rough estimation we might say that every 10% of improvement in *bike handling* could result in 13" gain down a 5-km technical section.__
