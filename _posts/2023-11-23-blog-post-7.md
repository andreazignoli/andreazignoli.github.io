---
title: 'Of eagels, sunflowers, and cycling trajecotries'
date: 23-11-2023
permalink: 
tags:
  - Bike handling
...
Interestingly, humans have created spiral shapes that don't exist in nature. This blog post looks at one such spiral called the _clothoid_, which in fact isn't found in nature. 

In the present blog post, we introduce and discuss a fascinating question. **Is there a case to be made that cyclists trace clothoids while descending?**
...
Through the neverending renegotiation of tiny adjustments, our movements and trajectories unfold. Those choices that promise greater success are embraced, learned, encoded in our neural circuitry, and eventually revisited. Human movement embodies an eternal journey of exploration and discovery, delving into the depths of our existence. Yet, amidst this ongoing quest, certain truths emerge as fundamental pillars of our ability to move: the intrinsic essence of movement itself is deeply rooted in the fabric of nature.
