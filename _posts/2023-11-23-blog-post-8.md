...
Thanks to the [invisible monitoring](https://hiitscience.com/the-paradox-of-invisible-monitoring-the-less-you-do-the-more-you-do/) system that Athletica has in place, if an historical maximal mean power is beaten (WR>0%) the athlete's [power/speed profile](https://athletica.ai/future-of-training-load-control-power-profiling/) is automatically updated. Athletica athletes can therefore leverage the internet connection of their Garmin devices to download the last speed/power profile available with their account.  
