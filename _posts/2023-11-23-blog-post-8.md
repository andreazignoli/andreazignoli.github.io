...
Thanks to the [invisible monitoring](https://hiitscience.com/the-paradox-of-invisible-monitoring-the-less-you-do-the-more-you-do/) system that Athletica has in place, if an historical maximal mean power is beaten (WR>0%) the [power/speed profile](https://athletica.ai/future-of-training-load-control-power-profiling/) is automatically updated for the next race/session. Athletica users can therefore leverage the internet connection of their Garmin device and download the last speed/power profile available with their account.  
