...
# Why the connection with Athletica is necessary? 

The main reasons why the WR App needs Athletica is because Athletica can compute your power/speed profile in the way that can be digested by the WR algorithm. Thanks to the [invisible monitoring](https://hiitscience.com/the-paradox-of-invisible-monitoring-the-less-you-do-the-more-you-do/) system that Athletica has in place, if an historical maximal mean power is beaten (WR>0%), the athlete's [power/speed profile](https://athletica.ai/future-of-training-load-control-power-profiling/) is automatically updated. Athletes can therefore leverage the internet connection of their Garmin devices to download the last speed/power profile available with their Athletica account before they start a new session/race.  
